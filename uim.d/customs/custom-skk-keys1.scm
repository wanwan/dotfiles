(define skk-on-key '("<Shift> "))
(define skk-on-key? (make-key-predicate '("<Shift> ")))
(define skk-latin-key '("<IgnoreCase>l"))
(define skk-latin-key? (make-key-predicate '("<IgnoreCase>l")))
